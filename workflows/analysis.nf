...
// Moduli  sdoppiati tramite Alias
...
workflow ATAC_CHIP_PIPELINE {
    ...
    if (!params.skip_profileplyr) {
        ...
        PROFILEPLYR_LANCE ( 
            ch_diffbind_lance_bed.collect().ifEmpty([]),             
        ...
        PROFILEPLYR_MACS ( 
            ch_diffbind_macs_bed.collect().ifEmpty([]),              
